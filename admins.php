                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3" >
                    ...
                    <form action="admins.php" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="password" name="passwordd" class="form-control" id="passwordd" placeholder="Password"  value="<?php if(isset($_GET['edit'])) echo $editrow['fld_user_passowrd']; ?>" required> 
                            </div>
                        </div>
                       ...
                       <div class="form-group">
                           ...
                           <div class="col-sm-9">
                               <textarea class="form-control" col="50" row="6" id="address" name="address" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_admin_address']; ?>"  required></textarea>
                           </div>
                        </div>
                       ...
                       <div class="form-group">
                            ...
                            <?php } ?><button type="reset" class="btn btn-default" type="reset" ><span class="glyphicon glyphicon-erase" aria-hidden="true"></span> Clear</button>  
                            </div>
                        </div>
